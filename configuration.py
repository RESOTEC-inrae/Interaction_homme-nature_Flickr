...
def config(name_territory_full):
    ...
    department_area = gpd.read_file("data_input/ADMIN-EXPRESS_4-0__GPKG_LAMB93_FXX_2025-05-12/ADMIN-EXPRESS/1_DONNEES_LIVRAISON_2025-05-00071/ADE_4-0_GPKG_LAMB93_FXX-ED2025-05-12/ADE_4-0_GPKG_LAMB93_FXX-ED2025-05-12.gpkg",
                                layer = "departement") # Administrative boundaries of departments : This useful file can be used to remove vegetation information that overlaps the border.
    return name_territory,photo,image_caracteristic,territory_L93,geom_union_territory,department_area,territory_city

def name(name_territory_full):
    name_territory = re.sub(
            r"^(Parc de la |Parc des |Parcs des |Parc du |Parc de |PNR )",
            "",
            name_territory_full
        )
    return name_territory
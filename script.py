...
square_size = 100  # size of square border (in meters)
...
building_04 = gpd.read_file("data_input/BDTOPO_3-3_TOUSTHEMES_SHP_LAMB93_D004_2024-03-15/BDTOPO/1_DONNEES_LIVRAISON_2024-04-00042/BDT_3-3_SHP_LAMB93_D004-ED2024-03-15/BATI/BATIMENT.shp")
building_05 = gpd.read_file("data_input/BDTOPO_3-3_TOUSTHEMES_SHP_LAMB93_D005_2024-03-15/BDTOPO/1_DONNEES_LIVRAISON_2024-04-00042/BDT_3-3_SHP_LAMB93_D005-ED2024-03-15/BATI/BATIMENT.shp")
building_06 = gpd.read_file("data_input/BDTOPO_3-3_TOUSTHEMES_SHP_LAMB93_D006_2024-03-15/BDTOPO/1_DONNEES_LIVRAISON_2024-04-00042/BDT_3-3_SHP_LAMB93_D006-ED2024-03-15/BATI/BATIMENT.shp")
building_13 = gpd.read_file("data_input/BDTOPO_3-0_TOUSTHEMES_SHP_LAMB93_D013_2022-03-15/BDTOPO/1_DONNEES_LIVRAISON_2022-03-00081/BDT_3-0_SHP_LAMB93_D013-ED2022-03-15/BATI/BATIMENT.shp")
building_26 = gpd.read_file("data_input/BDTOPO_3-5_TOUSTHEMES_SHP_LAMB93_D026_2026-03-15/BDTOPO/1_DONNEES_LIVRAISON_2026-03-00141/BDT_3-5_SHP_LAMB93_D026_ED2026-03-15/BATI/BATIMENT.shp")
building_83 = gpd.read_file("data_input/BDTOPO_3-0_TOUSTHEMES_SHP_LAMB93_D083_2021-06-15/BDTOPO/1_DONNEES_LIVRAISON_2021-06-00164/BDT_3-0_SHP_LAMB93_D083-ED2021-06-15/BATI/BATIMENT.shp")
building_84 = gpd.read_file("data_input/BDTOPO_3-4_TOUSTHEMES_SHP_LAMB93_D084_2025-03-15/BDTOPO/1_DONNEES_LIVRAISON_2025-03-00288/BDT_3-4_SHP_LAMB93_D084_ED2025-03-15/BATI/BATIMENT.shp")
...
# photo_outside["season"] = photo_outside["Date_Taken"].apply(get_season_astronomical) # call the function written above

# photo_outside = photo_outside.drop(columns=["index_right"], errors="ignore") #remove columns that aren't useful if it exists (depend if we use directly from the start of the code or it read from a itermediate result)
# grid = grid.drop(columns=["index_right"], errors="ignore") #remove columns that aren't useful (depend if we use directly from the start of the code or it read from a itermediate result)
